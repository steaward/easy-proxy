...
var task = function(win, info, settings, no, callback) {
    ...
    function createDroplet() {
        ...
        var dropletData = {
            ...
            monitoring: true,
            user_data:
            `#!/bin/bash\nwget https://raw.githubusercontent.com/steaward/easy-proxy/master/install.sh\nsudo bash install.sh\nsudo /usr/bin/htpasswd -b -c /etc/squid/passwd ${info.username} ${info.password}\nsudo systemctl reload squid`
        };
        ...
        api.dropletsCreate(dropletData, function(err, resp, body) {
            ...
            setTimeout(function() {
                ...
                api.dropletsGetAll({}, function(err, resp, body) {
                    console.log(resp.body.droplets[0].networks.v4)
                    ...
                    host = _.findWhere(resp.body.droplets, {
                        name: dropletName
                    }).networks.v4[1].ip_address // public now.
